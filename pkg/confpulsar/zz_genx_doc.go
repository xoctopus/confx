...
func (v *Option) DocOf(names ...string) ([]string, bool) {
	if len(names) > 0 {
		...
		case "prefix":
			return []string{"persistent topic url prefix"}, true
		...
		case "defaultPubOption":
			return []string{"default publisher option"}, true
		case "defaultSubOption":
			return []string{"defaultPubOption default subscriber option"}, true
		}
		return []string{}, false
	}
