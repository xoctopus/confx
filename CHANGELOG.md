...
* regenerate and upgrade dependencies
...
<a name="v0.4.6-rc6"></a>
## [v0.4.6-rc6](https://github.com/xoctopus/confx/compare/v0.4.6-rc5...v0.4.6-rc6)
...
* upgrade deps
* **confjwt:** auth status error and unit tests


<a name="v0.4.6-rc5"></a>
## [v0.4.6-rc5](https://github.com/xoctopus/confx/compare/v0.4.6-rc4...v0.4.6-rc5)

> 2026-06-15

### Feat

* **liveness:** add Detail for liveness result
...
<a name="v0.3.3"></a>
## [v0.3.3](https://github.com/xoctopus/confx/compare/v0.3.2...v0.3.3)
...
<a name="v0.2.24"></a>
## [v0.2.24](https://github.com/xoctopus/confx/compare/v0.2.23...v0.2.24)
...
* **confpulsar:** processing mode for subscribing
...
<a name="v0.2.22"></a>
## [v0.2.22](https://github.com/xoctopus/confx/compare/v0.2.21...v0.2.22)
