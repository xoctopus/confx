...
func WithRabbitMQ(ctx context.Context, t testing.TB, dsn string) context.Context {
	Check(t)
...
func TryWithRabbitMQ(ctx context.Context, t testing.TB, dsn string) (context.Context, error) {
	Check(t)
...
func WithRabbitMQLost(ctx context.Context, t testing.TB, dsn string) context.Context {
	_, err := url.Parse(dsn)
	Expect(t, err, Succeed())
...
func RunRabbitMQPubSubTestSuite(
	ctx context.Context,
	t testing.TB,
	dsn string,
